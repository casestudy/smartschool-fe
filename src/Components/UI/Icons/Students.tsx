...
const Student: React.FC = () => {
  const StudentSvg = () => (
    ...
    height="60" width="70" viewBox="0 0 31.283 31.284">
        <g>
            <g>
  ...
  const StudentIcon = (props: Partial<CustomIconComponentProps>) => (
    <Icon component={StudentSvg} {...props} />
  );
  return <StudentIcon style={{ backgroundColor: 'transparent', borderRadius: "50px"}} />;
};
