...
const Teacher: React.FC = () => {
  const TeacherSvg = () => (
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" height="60" width="70" x="0px" y="0px"
	 viewBox="0 0 512 512">
        <g>
            <g>
  ...
  return <TeacherIcon style={{ backgroundColor: 'transparent', borderRadius: "50px"}} />;
};
