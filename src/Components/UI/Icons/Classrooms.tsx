...
const Classrooms: React.FC = () => {
  const ClassSvg = () => (
    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" height="60" width="70" viewBox="0 0 31.79 31.79"
	>
        <g>
            <g>
                <path d="M16.118,9.33c-1.32,0-2.394,1.074-2.394,2.395c0,1.319,1.073,2.394,2.394,2.394s2.396-1.074,2.396-2.394
                    ...
                    l0.055,0.106l-0.217,0.11c-0.017-0.036-0.033-0.072-0.053-0.106L18.135,10.755z"/>
                <path d="M21.805,15.549v-4.707l-5.734-5.42l-5.707,5.42v4.707H0v13.465h14.186v-5.791h3.768v5.791l13.836,0.043V15.592
                    ...
                    h-2.51v-2.453h2.51V21.254z M29.85,24.879h-2.512v-2.455h2.512V24.879z M29.936,21.254h-2.512v-2.453h2.512V21.254z"/>
                <polygon points="16.158,4.645 22.79,11.241 23.756,10.27 16.177,2.733 8.322,10.234 9.269,11.225 		"/>
            </g>
        </g>
    </svg>
  );
  const ClassroomIcon = (props: Partial<CustomIconComponentProps>) => (
    <Icon component={ClassSvg} {...props} />
  );
  return <ClassroomIcon style={{ backgroundColor: 'transparent', borderRadius: "50px"}} />;
};
