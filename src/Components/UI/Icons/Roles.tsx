...
const Roles: React.FC = () => {
  const RoleSvg = () => (
    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 83.848 83.848" height="60" width="70">
        <g>
            <g>
  ...
  const RoleIcon = (props: Partial<CustomIconComponentProps>) => (
    <Icon component={RoleSvg} {...props} />
  );
  return <RoleIcon style={{ backgroundColor: 'transparent', borderRadius: "50px"}} />;
};
