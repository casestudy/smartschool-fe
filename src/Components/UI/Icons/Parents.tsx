...
const Parent: React.FC = () => {
  const ParentSvg = () => (
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" height="60" width="70"
  ...
  const ParentIcon = (props: Partial<CustomIconComponentProps>) => (
    <Icon component={ParentSvg} {...props} />
  );
  return <ParentIcon style={{ backgroundColor: 'transparent', borderRadius: "50px"}} />;
};
