...
const MoonIcon: React.FC = () => {
  const MoonSvg = () => (
    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" height="20" width="20" color='blue' x="0px" y="0px"
	 viewBox="0 0 49.739 49.739">
<path fill="black" d="M25.068,48.889c-9.173,0-18.017-5.06-22.396-13.804C-3.373,23.008,1.164,8.467,13.003,1.979l2.061-1.129l-0.615,2.268
