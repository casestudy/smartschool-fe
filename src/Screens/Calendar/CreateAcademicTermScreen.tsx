...
import CreateAcademicTerm from '../../Components/Form/Calendar/CreateAcademicTermForm';
                    ...
                    <Col md={18}>
						...
						<StyledFormBody style={{padding: "5rem 5rem 1px 5rem"}}>
                            ...
                            {(state.termid !== undefined)? 
                                        <CreateAcademicTerm disp="block" yearid={state.yearid} 
                                                            termid={state.termid}
                                                            sdate={state.startdate}
                                                            edate={state.enddate} ttype={state.ttype}/> : 
                                        <CreateAcademicTerm disp="none"/>}
