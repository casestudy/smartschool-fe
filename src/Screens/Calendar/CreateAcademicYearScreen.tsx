...
import CreateAcademicYear from '../../Components/Form/Calendar/CreateAcademicYearForm';
import { Col, Row } from "antd";

const CreateAcademicYearScreen: React.FC<any> = () => {
                ...
                <Row>
                    <Col md={18}>
						...
						<StyledFormBody style={{padding: "5rem 5rem 1px 5rem"}}>
							<Filler/>
                            {(state.yearid !== undefined)? 
                                        <CreateAcademicYear disp="block" yearid={state.yearid} 
                                                            sdate={state.startdate}
                                                            edate={state.enddate} description={state.descript}/> : 
                                        <CreateAcademicYear disp="none"/>}
...
const Filler = styled.div`
	width: 5%;
`;
export default CreateAcademicYearScreen;